    ...
    <footer className="bg-[#002147] text-[#FFFFFF] text-white pt-12 pb-6">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* About Us */}
          <div>
            <h3 className="font-heading text-xl font-bold mb-4">Ganesh Swagruha Foods</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/visit" className="text-primary-100 hover:text-white transition-colors">
                  Visit Us
                </Link>
              </li>
              <li>
          ...
          {/* Product Categories */}
          <div>
            <h3 className="font-heading text-lg font-bold mb-4">Product Categories</h3>
            <ul className="space-y-2">
              <li>
                <Link to="/products#snacks" className="text-primary-100 hover:text-white transition-colors">
                  Snacks
                </Link>
              </li>
              <li>
                <Link to="/products#traditional-snacks" className="text-primary-100 hover:text-white transition-colors">
                  Traditional Snacks
                </Link>
              </li>
              <li>
                <Link to="/products#sweets" className="text-primary-100 hover:text-white transition-colors">
                  Sweets
                </Link>
              </li>
              <li>
                <Link to="/products#papads" className="text-primary-100 hover:text-white transition-colors">
                  Papads
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-primary-100">Visit our store for offline purchases</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-primary-700 mt-8 pt-6 text-center text-primary-300 text-sm">
          <p>&copy; {currentYear} Ganesh Swagruha Foods. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
